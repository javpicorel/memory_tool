...
COMPONENT_PARAMETERS(
  PARAMETER( MaxPrefetches, unsigned int, "Maximum number of parallel prefetches", "prefetches", 16 )
  PARAMETER( QueueSizes, unsigned int, "Size of request & response queues", "queue_size", 8 )
