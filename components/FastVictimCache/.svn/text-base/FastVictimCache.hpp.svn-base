...
COMPONENT_PARAMETERS(
    ...
    PARAMETER( NumEntries, unsigned int, "Number of victim cache entries", "entries", 4 )
    PARAMETER( CacheLineSize, unsigned int, "Cache line size in bytes", "cache_line_size", 64 )
);
