...
COMPONENT_PARAMETERS(
    PARAMETER( ReuseWindowSizeInCycles, unsigned long long, "Reuse distance window size in cycles", "reuse_win_size", 100000000 ) // 100M cycles
    PARAMETER( BlockSize, int, "Block size in bytes", "bsize", 64 )
    PARAMETER( IgnoreBlocksWithMinDist, int, "Ignore blocks with long reuse distance (0=off)", "ignore_blk_dist", 0 )  // 0 L2 refs (off)
);
