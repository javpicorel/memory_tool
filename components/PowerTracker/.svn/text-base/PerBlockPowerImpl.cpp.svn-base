...
void PerBlockPower::setNumTiles(const unsigned int newNumCoreTiles, const unsigned int newNumL2Tiles) {
	if (corePowers) {
		delete[] corePowers;	
	}
	if (l2uDynamic) {
...
double PerBlockPower::getCoreDynamic(const unsigned int i) const {
...
double PerBlockPower::getCoreLeakage(const unsigned int i) const {
...
double PerBlockPower::getCorePower(const unsigned int i) const {
