...
void TemperatureTracker::initialize(thermal_config_t &config, const std::string floorplanFile, const unsigned int interval, const unsigned int aNumCoreTiles, const unsigned int aNumL2Tiles) {
	double icacheArea,
		   dcacheArea,
		   bpredArea,
		   dtbArea,
...
double TemperatureTracker::getCoreTemperature(const unsigned int i) {
	std::string index;
	std::ostringstream ossIndex;
...
double TemperatureTracker::getL2Temperature(const unsigned int i) {
	std::ostringstream ossIndex;
    ossIndex << i << "-L2";
