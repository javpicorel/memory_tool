...
COMPONENT_PARAMETERS(
    ...
    PARAMETER( NumL2TilesPerMC, int, "Number of L2 tiles per MC in the CMP network", "numL2TilesPerMC", 4)
...
COMPONENT_INTERFACE(
  DYNAMIC_PORT_ARRAY(  PushOutput, MemoryTransport, LoopbackOut )
  DYNAMIC_PORT_ARRAY(  PushInput,  MemoryTransport, LoopbackIn )
  DRIVE( LoopbackDrive )
);
