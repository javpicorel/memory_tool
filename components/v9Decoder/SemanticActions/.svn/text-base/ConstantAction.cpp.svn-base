...
struct ConstantAction : public PredicatedSemanticAction {
  unsigned long long theConstant;
  eOperandCode theResult;
  boost::optional<eOperandCode> theBypass;

  ConstantAction( SemanticInstruction * anInstruction, unsigned long long aConstant, eOperandCode aResult, boost::optional<eOperandCode> aBypass )
  ...
  void doEvaluate() {
    theInstruction->setOperand(theResult, static_cast<unsigned long long>(theConstant));
