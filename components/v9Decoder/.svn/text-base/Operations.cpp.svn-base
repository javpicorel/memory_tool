...
struct Add : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    return boost::get<unsigned long long>(operands[0]) + boost::get<unsigned long long>(operands[1]);
  }
...
struct AddTrunc : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 2);
    return ( (boost::get<unsigned long long>(operands[0]) + boost::get<unsigned long long>(operands[1])) & 0xFFFFFFFFULL );
  }
  virtual char const * describe() const {
    return "AddTrunc";
  }
...
struct Align : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    return ( (boost::get<unsigned long long>(operands[0]) + boost::get<unsigned long long>(operands[1])) & ~(7ULL) );
  }
  virtual Operand evalExtra( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 3);
    int bits = (boost::get<unsigned long long>(operands[0]) + boost::get<unsigned long long>(operands[1])) & 7ULL;
    unsigned long long gsr = (boost::get<unsigned long long>(operands[2]) & ~7) | bits;
...
struct AddC : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    return boost::get<unsigned long long>(operands[0]) + boost::get<unsigned long long>(operands[1]) + carry;
  }
  virtual char const * describe() const {
    return "AddC";
  }
...
struct UMul : public Operation  {
  unsigned long long calc(std::vector<Operand> const & operands) {
    DBG_Assert( operands.size() == 2);
    unsigned long long op0 = boost::get<unsigned long long>(operands[0]) & 0xFFFFFFFF;
    unsigned long long op1 = boost::get<unsigned long long>(operands[1]) & 0xFFFFFFFF;
    unsigned long long prod = op0 * op1;
    return prod;
  }
  virtual Operand operator()( std::vector<Operand> const & operands) {
...
struct SMul : public Operation  {
  unsigned long long calc( std::vector<Operand> const & operands) {
    DBG_Assert( operands.size() == 2);
    unsigned long long op0 = boost::get<unsigned long long>(operands[0]) & 0xFFFFFFFFULL;
    unsigned long long op1 = boost::get<unsigned long long>(operands[1]) & 0xFFFFFFFFULL;
    long long op0_s = op0 | ( op0 & 0x80000000ULL ? 0xFFFFFFFF00000000ULL : 0ULL );
    long long op1_s = op1 | ( op1 & 0x80000000ULL ? 0xFFFFFFFF00000000ULL : 0ULL );
    long long prod = op0_s * op1_s;
...
struct UDiv : public Operation  {
  unsigned long long calc( std::vector<Operand> const & operands) {
    ...
    unsigned long long op0 = boost::get<unsigned long long>(operands[0]) & 0xFFFFFFFF;
    unsigned long long op1 = boost::get<unsigned long long>(operands[1]) & 0xFFFFFFFF;
    unsigned long long y = boost::get<unsigned long long>(operands[2]) & 0xFFFFFFFF;
    unsigned long long dividend = op0 | (y << 32 );
    if (op1 == 0) {
      return 0ULL; //ret_val is irrelevant when divide by zero
    }
    unsigned long long prod = dividend / op1;
...
struct SDiv : public Operation  {
  unsigned long long calc( std::vector<Operand> const & operands) {
    ...
    unsigned long long op1 = boost::get<unsigned long long>(operands[1]) & 0xFFFFFFFF;
    unsigned long long y = boost::get<unsigned long long>(operands[2]) & 0xFFFFFFFF;
    long long dividend = op0 | (y << 32 );
    long long divisor = op1 | (op1 & 0x80000000ULL ? 0xFFFFFFFF00000000ULL : 0ULL);
    if (divisor == 0) {
      return 0ULL; //ret_val is irrelevant when divide by zero
    }
    long long prod = dividend / divisor;
    if (prod > 0x7FFFFFFF) {
       prod = 0x7FFFFFFFLL;
...
struct UDivX : public Operation  {
  virtual Operand operator()( std::vector<Operand> const & operands) {
    DBG_Assert( operands.size() == 2);
    if (boost::get<unsigned long long>(operands[1]) != 0) {
      return boost::get<unsigned long long>(operands[0]) / boost::get<unsigned long long>(operands[1]);
    } else {
...
struct SDivX : public Operation  {
  virtual Operand operator()( std::vector<Operand> const & operands) {
    DBG_Assert( operands.size() == 2);
    long long op0_s = boost::get<unsigned long long>(operands[0]);
    long long op1_s = boost::get<unsigned long long>(operands[1]);
    if (op1_s != 0) {
      return static_cast<unsigned long long>( op0_s / op1_s);
    } else {
      return 0ULL; //Will result in an exception, so it doesn't matter what we return
    }
  }
...
struct MovCC : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long false_val = boost::get<unsigned long long>(operands[0]);
    unsigned long long true_val = boost::get<unsigned long long>(operands[1]);
    std::bitset<8> cc = boost::get<std::bitset<8> >(operands[2]);
    unsigned long long packed_condition = boost::get<unsigned long long >(operands[3]);
...
struct MovR : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long false_val = boost::get<unsigned long long>(operands[0]);
    unsigned long long true_val = boost::get<unsigned long long>(operands[1]);
    unsigned long long cond_reg = boost::get<unsigned long long>(operands[2]);
    unsigned long long condition = boost::get<unsigned long long >(operands[3]);
...
struct ULONG2ICC : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 1);
    unsigned long long val = boost::get<unsigned long long >(operands[0]);
...
struct Add_CC: public Operation {
 virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long op1 = boost::get<unsigned long long>(operands[0]);
    unsigned long long op2 = boost::get<unsigned long long>(operands[1]);
    unsigned long long val = boost::get<unsigned long long>(Add_(operands));
    std::bitset<8> ccbits;
    ...
    unsigned long long xcarry_add = (op1 >> 1) + (op2 >> 1) + ( 1 & op1 & op2 );
    bool xcarry = xcarry_add & (1ULL << 63);
    ccbits[xccC] = xcarry;
    unsigned long long icarry_add = (op1 & 0xFFFFFFFFULL) + (op2 & 0xFFFFFFFFULL);
...
struct AddC_CC: public Operation {
 virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long val = boost::get<unsigned long long>(operands[0]) + boost::get<unsigned long long>(operands[1]) + carry;
    std::bitset<8> ccbits;
    ...
    ccbits[xccV] = ( op1_63 == op2_63 ) && ( op1_63 != val_63 ) ;
    ccbits[iccV] = ( op1_31 == op2_31 ) && ( op1_31 != val_31 ) ;
    unsigned long long xcarry_add = (op1 >> 1) + (op2 >> 1) + ( (op1_0 & op2_0) | (op1_0 & carry) | (op2_0 & carry) );
    bool xcarry = xcarry_add & (1ULL << 63);
    ccbits[xccC] = xcarry;
    unsigned long long icarry_add = (op1 & 0xFFFFFFFFULL) + (op2 & 0xFFFFFFFFULL);
    bool icarry = icarry_add & (1ULL << 32);
...
struct Sub_CC : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands) {
    unsigned long long op1 = boost::get<unsigned long long>(operands[0]);
    unsigned long long op2 = boost::get<unsigned long long>(operands[1]);
    unsigned long long val = boost::get<unsigned long long>(Sub_(operands));
    std::bitset<8> ccbits;
    ...
    unsigned long long xborrow_sub = (op1 >> 1) - (op2 >> 1) -  ( (op2 & 1 & (~op1) ))  ;
    bool xborrow = xborrow_sub &  ( 1ULL << 63 );
    ccbits[xccC] = xborrow;

    unsigned long long iborrow_sub = (op1 & 0xFFFFFFFFULL) - (op2 & 0xFFFFFFFFULL);
...
struct SubC_CC: public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands) {
    ...
    unsigned long long xborrow_sub = (op1 >> 1) - (op2 >> 1) -  borrow0  ;
    bool xborrow = xborrow_sub &  ( 1ULL << 63 );
    ccbits[xccC] = xborrow;

    unsigned long long iborrow_sub = (op1 & 0xFFFFFFFFULL) - (op2 & 0xFFFFFFFFULL) - carry;
    bool iborrow = iborrow_sub & (1ULL << 32);
    ccbits[iccC] = iborrow;
    return ccbits;
  }
...
struct Logical_CC : public Operation {
  ...
  virtual Operand operator()( std::vector<Operand> const & operands) {
    ...
    unsigned long long val = boost::get<unsigned long long>(Op(operands));
...
struct SDiv_CC: public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long y = boost::get<unsigned long long>(operands[2]) & 0xFFFFFFFF;
    long long dividend = op0 | (y << 32 );
    long long divisor = op1 | (op1 & 0x8000000ULL ? 0xFFFFFFFF00000000ULL : 0ULL);
    std::bitset<8> ccbits;
    if (divisor == 0) {
      return ccbits; //ret_val is irrelevant when divide by zero
    }
...
struct SLL_32 : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 2);
    return boost::get<unsigned long long>(operands[0] ) << ( boost::get<unsigned long long>(operands[1]) & 0x1F) ;
  }
  virtual char const * describe() const {
    return "SLL";
  }
...
struct SLL_64 : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 2);
    return boost::get<unsigned long long>(operands[0]) << ( boost::get<unsigned long long>(operands[1]) & 0x3F);
  }
  virtual char const * describe() const {
    return "SLLX";
  }
...
struct SRL_32 : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long val = boost::get<unsigned long long>(operands[0]);
    val &= 0xFFFFFFFFULL;
    val >>= ( boost::get<unsigned long long>(operands[1]) & 0x1F);
    return val;
  }
  virtual char const * describe() const {
    return "SRL";
...
struct SRA_32 : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 2);
    unsigned long long val = boost::get<unsigned long long>(operands[0]) & 0xFFFFFFFFULL;
...
struct SRA_64 : public Operation {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long shift = ( boost::get<unsigned long long>(operands[1]) & 0x3F);
    mask >>= shift;
    mask = ~mask;
    val >>= shift;
    if (bit) {
...
struct FADDs : public FPOP {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 2);
    unsigned long op0 = boost::get<unsigned long long>(operands[0]);
    unsigned long op1 = boost::get<unsigned long long>(operands[1]);
...
struct FADDd : public FPOP {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 4);
    unsigned long long op0 = boost::get<unsigned long long>(operands[0]) << 32;
    op0 |= boost::get<unsigned long long>(operands[1]);
    unsigned long long op1 = boost::get<unsigned long long>(operands[2]) << 32;
    op1 |= boost::get<unsigned long long>(operands[3]);
...
struct FMOVs : public FPOP {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    DBG_Assert( operands.size() == 1);
    unsigned long op0 = boost::get<unsigned long long>(operands[0]);
    return static_cast<unsigned long long>(op0);
  }
  virtual char const * describe() const {
    return "FMOVs";
  }
...
struct FCMPs : public FPOP {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    std::bitset<8> ccval(static_cast<unsigned long>(result));
...
struct FALIGNDATA : public FPOP {
  virtual Operand operator()( std::vector<Operand> const & operands  ) {
    ...
    unsigned long long op1 = boost::get<unsigned long long>(operands[2]) << 32;
    op1 |= boost::get<unsigned long long>(operands[3]);
    int gsr = boost::get<unsigned long long>(operands[4]);
    int align = gsr & 0x7;
    ...
    //so on.
    unsigned long long result = (op0 << ( 8 * align));
    //Shift op1 right by 8 - align bytes, and or into the bottom of result
    unsigned long long intermed = (op1 >> (8 * ( 8 - align) ));
    if (align == 0) {
      intermed = 0;
    }
    result |= intermed;
