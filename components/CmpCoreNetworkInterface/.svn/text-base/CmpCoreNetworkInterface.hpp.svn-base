...
COMPONENT_PARAMETERS(
  ...
  FLEXUS_PARAMETER( RecvCapacity, unsigned int, "Recv Queue Capacity", "recvCapacity", 1)
  FLEXUS_PARAMETER( SendCapacity, unsigned int, "Send Queue Capacity", "sendCapacity", 1)
