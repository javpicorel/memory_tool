...
static const int kFE_StrictRoundRobin = 0;
static const int kFE_ICount = 1;

static const int kBE_StrictRoundRobin = 0;
static const int kBE_SmartRoundRobin = 1;

COMPONENT_PARAMETERS(
  PARAMETER(Cores, unsigned int, "Number of cores", "cores", 1 )
  PARAMETER(Threads, unsigned int, "Number of threads per core", "threads", 1 )
