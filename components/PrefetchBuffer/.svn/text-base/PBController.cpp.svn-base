...
namespace nPrefetchBuffer {
  ...
  class PBControllerImpl : public PBController {
    ...
    struct PBTableEntry {
      ...
      mutable unsigned char theWritable;
      mutable ePrefetchFillType theFillType;
      mutable tFillLevel theFillLevel;
      PBTableEntry(MemoryAddress const & anAddress, unsigned char aWritable, ePrefetchFillType aFillType, tFillLevel aFillLevel)
  ...
  public:
    ...
    PBControllerImpl(PB * aPB, std::string const & aName, unsigned aNodeId, int aNumEntries, int aWatchEntries, bool anEvictClean, bool aUseStreamFetch)
      : thePB(aPB)
      , theName(aName)
      , theNodeId(aNodeId)
  ...
  private:
    ...
    eAction processPrefetch( boost::intrusive_ptr<PrefetchMessage>  msg, boost::intrusive_ptr<TransactionTracker>  tracker, bool hasMAFConflict ) {
      ...
      if (theNumEntries == 0) { return kNoAction; }
...
PBController * PBController::construct(PB * aPB, std::string const & aName, unsigned aNodeId, int aNumEntries, int aWatchEntries, bool anEvictClean, bool aUseStreamFetch) {
