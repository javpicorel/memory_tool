...
COMPONENT_PARAMETERS(
  PARAMETER( NumEntries, unsigned int, "# of entries in the prefetch buffer", "entries", 0 )
  PARAMETER( NumWatches, unsigned int, "# of addresses that can be simultaneously watched", "watches", 16 )
  ...
  PARAMETER( ProcessingDelay, unsigned int, "# of cycles to process a message", "delay", 0 )
