...
COMPONENT_PARAMETERS(
    PARAMETER( MaxFetchAddress, unsigned int, "Max fetch addresses generated per cycle", "faddrs", 10 )
    PARAMETER( MaxBPred, unsigned int, "Max branches predicted per cycle", "bpreds", 2 )
    PARAMETER( Threads, unsigned int, "Number of threads under control of this FAG", "threads", 1 )
);
