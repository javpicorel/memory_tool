...
COMPONENT_PARAMETERS(
    PARAMETER( SBSize, unsigned int, "Store buffer size", "sb", 0 )
    PARAMETER( ROBSize, unsigned int, "Reorder buffer size", "rob", 16 )
    PARAMETER( LSQSize, unsigned int, "Load-Store queue size", "lsq", 8 )
    PARAMETER( MemoryWidth, unsigned int, "Mem width", "memory", 4 )
