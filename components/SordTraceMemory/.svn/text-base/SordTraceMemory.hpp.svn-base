...
#define SordTraceMemory_IMPLEMENTATION (<components/SordTraceMemory/SordTraceMemoryImpl.hpp>)
...
namespace nSordTraceMemory {
  ...
  #define FLEXUS_PREVIOUS_MemoryTransport_Typemap nSordTraceMemory::MemoryTransport_Typemap

} //End nSordTraceMemory


#include FLEXUS_END_COMPONENT_DECLARATION()
#define FLEXUS_END_COMPONENT SordMemory
