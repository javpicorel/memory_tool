...
COMPONENT_PARAMETERS(
  ...
  PARAMETER( QueueSizes, unsigned int, "Size of request & response queues", "queue_size", 4 )
  PARAMETER( SVBSize, unsigned int, "Size of SVB in cache blocks", "size", 64 )
  PARAMETER( ProcessingDelay, unsigned int, "Processing Delay of SVB accesses", "delay", 0 )
