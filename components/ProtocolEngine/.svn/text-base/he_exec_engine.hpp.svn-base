...
*/
 ...
 public:
  ...
  // initialization
  void init(void)      { tMicrocodeEmulator::init(); }

  // statistics
  void dump_mcd_stats(void) const     { tMicrocodeEmulator::dump_mcd_stats(); }     // print mc stats
  void dump_mcd_counters(void) const  { tMicrocodeEmulator::dump_mcd_counters(); }  // dump counters to xe.cnt file
 ...
 private:
  ...
  void handle_HE_INSTR_SEND(tThread aThread, const unsigned long args);
  void handle_HE_INSTR_SEND_FWD(tThread aThread, const unsigned long args);
  void handle_HE_INSTR_RECEIVE(tThread aThread, const unsigned long args);
  void handle_HE_INSTR_TEST(tThread aThread, const unsigned long args);
  void handle_HE_INSTR_SET(tThread aThread, const unsigned long args);
  void handle_HE_INSTR_UNLOCK(tThread aThread);
  void handle_HE_INSTR_CPU_OP(tThread aThread, const unsigned long args);
  void handle_HE_INSTR_WRITE_DIRECTORY(tThread aThread);
  void handle_HE_INPUT_Q_OP(tThread aThread, const unsigned long args);
