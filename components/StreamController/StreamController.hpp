...
COMPONENT_PARAMETERS(
  PARAMETER( StreamQueues, unsigned int, "Number of stream queues", "queues", 0 ) //0 is unbounded
  PARAMETER( FetchTarget, unsigned int, "Number of blocks per stream to fetch", "target", 4 )
  PARAMETER( MessageQueueSizes, unsigned int, "Size of message queues", "msg_queues", 8 )
