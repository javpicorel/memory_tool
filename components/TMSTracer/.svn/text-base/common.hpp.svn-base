...
struct TraceCoordinator {
  ...
  virtual void accessL2( unsigned long long aTime, tEventType aType, tID aNode, tAddress anAddress, tVAddress aPC, tFillType aFillType, tFillLevel aFillLevel, bool anOS) =0;
  virtual void accessOC( unsigned long long aTime, tEventType aType, tID aNode, tAddress anAddress, tVAddress aPC, tFillType aFillType, tFillLevel aFillLevel, bool anOS) =0;
  virtual void finalize() = 0;
};

struct TraceData {
  TraceData() {}
  TraceData( unsigned long long aTime, tEventType anEventType, tID aNode, tAddress anAddress, tVAddress aPC, tFillType aFillType, tFillLevel aFillLevel,  bool isOS )
    : theTime(aTime)
  ...
  tID theNode;
  tAddress theAddress;
  tVAddress  thePC __attribute__ ((packed));
...
TraceCoordinator * initialize_TMSTracer(int aNumNodes);
