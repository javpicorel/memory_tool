...
COMPONENT_INTERFACE(
  PORT(PushInput,  MemoryTransport, MonitorMemRequests_In)
  PORT(PushOutput, MemoryTransport, MonitorMemRequests_Out)
  PORT(PushInput,  MemoryTransport, MonitorMemPrefetch_In)
  PORT(PushOutput, MemoryTransport, MonitorMemPrefetch_Out)

  DYNAMIC_PORT_ARRAY(PushOutput,  MemoryTransport, TMSc_MemRequests)
