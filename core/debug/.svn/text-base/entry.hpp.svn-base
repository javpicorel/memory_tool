...
class Entry {
  ...
  public:
    Entry(Severity aSeverity, char const * aFile, long aLine, char const * aFunction, long aGlobalCount, long long aCycleCount);
    Entry & set(std::string const & aFieldName);
    Entry & set(std::string const & aFieldName, std::string const & aFieldValue);
    Entry & set(std::string const & aFieldName, long long aFieldValue);
    ...
    long long getNumeric(std::string aFieldName) const;
