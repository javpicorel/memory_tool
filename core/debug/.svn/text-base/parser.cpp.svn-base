...
namespace aux_ {
  ...
  int s_tmp = SevTmp;
  int s_dev = SevDev;
  int s_trace = SevTrace;
  int s_iface = SevIface;
  int s_vverb = SevVerb;
  int s_verb = SevVVerb;
  int s_inv = SevInv;
  ...
  struct Context {
    ...
    public:
      ...
      void addAtStmt(long long aCycle, Action * anAction) {  //Ownership of anAction passed in
  ...
  struct at_closure : public boost::spirit::closure<at_closure, unsigned long long> {
      member1 theCycle;
  };
  ...
  struct return_longlong_closure : public boost::spirit::closure<return_longlong_closure, long long> {
      member1 theRetVal;
  };
  ...
  struct severity_filter_closure : public boost::spirit::closure<severity_filter_closure, Filter *, long long> {
      member1 theRetVal;
      member2 theSeverity;
  };

  struct return_severity_closure : public boost::spirit::closure<return_severity_closure, long long> {
      member1 theRetVal;
  };
      ...
      //The grammar definition
        definition(DebugGrammar const& self) {
            ...
            numeric_value         =   str_p("0x")
                                      >> int_parser<long long, 16, 1, -1>()
                                        [ numeric_value.theRetVal = arg1 ]
                                  |   int_parser<long long, 10, 1, -1>()
                                        [ numeric_value.theRetVal = arg1 ]
                                  ;
