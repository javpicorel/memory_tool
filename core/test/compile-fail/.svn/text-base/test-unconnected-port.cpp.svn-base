...
FLEXUS_COMPONENT class WiringSource  {
  ...
  public:
    ...
    struct PushOut : public PushOutputPort < const int > {};
...
FLEXUS_COMPONENT class WiringSink  {
  ...
  public:
    ...
    void initialize() {}
      ...
      struct PushIn : public PushInputPort < const int >, AlwaysAvailable {
        template <class Handle, class Wiring>
        static void push(self & theComponent, const int anInt) {
