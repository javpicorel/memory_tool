...
namespace serialization {
  ...
  void save(Archive & ar, ::boost::intrusive_ptr<T> const & ptr, unsigned int version) {
    T * t = ptr.get();
    ar & t;
  }

  template<class Archive, class T>
  void load(Archive & ar, ::boost::intrusive_ptr<T> & ptr, unsigned int version) {
    T * t;
    ar & t;
  ...
  template<class Archive, class T>
  inline void serialize( Archive & ar, ::boost::intrusive_ptr<T> & t, const unsigned int file_version ){
