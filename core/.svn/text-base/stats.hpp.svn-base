...
class Prediction : public boost::counted_base {
    ...
    long long theUpdate;
  public:
    Prediction(long long anUpdate);
    ~Prediction();
    void connectCounter( boost::intrusive_ptr< aux_::StatValue_PredictionCounter > aCounter);
    void confirm();
    void confirm(long long anOverride);
    void dismiss();
    void guess();
    void guess(long long anOverride);
    void goodGuess();
    void reject();
    void reject(long long anOverride);
};
...
struct StatManager {
  ...
  virtual void openPeriodicMeasurement(std::string const & aName, long long aPeriod, accumulation_type anAccumulation, std::string const & aStatSpec = std::string(".*")) = 0;
  virtual void openLoggedPeriodicMeasurement(std::string const & aName, long long aPeriod, accumulation_type anAccumulation, std::ostream & anOstream, std::string const & aStatSpec = std::string(".*")) = 0;
  ...
  virtual void tick(long long anAdvance = 1) = 0;
  virtual long long ticks() = 0;
  virtual void reduceNodes(std::string const & aMeasurementSpec) = 0;
  virtual void addEvent(long long aDeadline, boost::function<void()> anEvent) = 0;
...
class StatCounter : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_Counter::update_type > > {
  ...
  public:
    ...
    StatCounter( std::string const & aName, long long anInitialValue = 0 )
      : Stat( aName )
      , theUpdater(0)
    ...
    StatCounter( std::string const & aName , Component * aComponent, long long anInitialValue = 0)
    ...
    //Increment Counter
    StatCounter & operator ++() { if (theUpdater) theUpdater->update(1); return *this; }
    StatCounter & operator ++(int) { if (theUpdater) theUpdater->update(1); return *this; }
    ...
    //Increase Counter
    StatCounter & operator +=( stat_value_type::update_type anUpdate) { if (theUpdater) theUpdater->update(anUpdate); return *this; }
...
class StatDoubleCounter : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_DoubleCounter::update_type > > {
  ...
  public:
    ...
    template <class Component>
    StatDoubleCounter( std::string const & aName , Component * aComponent, long long anInitialValue = 0)
      : Stat( aComponent->statName() + "-" + aName)
      , theUpdater(0)
      , theInitialValue(anInitialValue)
      {
...
class StatPredictionCounter : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_PredictionCounter::update_type > > {
  ...
  public:
    ...
    template <class Component>
    StatPredictionCounter( std::string const & aName , Component * aComponent, long long anInitialValue = 0)
      : Stat( aComponent->statName() + "-" + aName)
      , theUpdater(0)
      {
        registerStat();
    ...
    std::string const & type() const { static std::string theType("PredictionCounter"); return theType; }

    //Increment Counter
    boost::intrusive_ptr<Prediction> predict(long long anIncrement = 1) {
...
class StatMax : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_Max::update_type > >  {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("Max"); return theType; }

    //Increment Counter
    StatMax & operator <<(stat_value_type::update_type anUpdate) { if (theUpdater) theUpdater->update(anUpdate); return *this; }
...
class StatAnnotation : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_Annotation::update_type > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("Annotation"); return theType; }

    //Increment Counter
    StatAnnotation & operator = (stat_value_type::update_type anUpdate) { if (theUpdater) theUpdater->update(anUpdate); theInitialValue = anUpdate; return *this; }
    StatAnnotation & operator << (stat_value_type::update_type anUpdate) { if (theUpdater) theUpdater->update(anUpdate); return *this; }
...
class StatAverage : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_Average::update_type > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("Average"); return theType; }

    //Increment Counter
    StatAverage & operator <<(stat_value_type::update_type anUpdate) { if (theUpdater) theUpdater->update(anUpdate); return *this; }
    StatAverage & operator <<(stat_value_type::update_type::first_type anUpdate) { if (theUpdater) theUpdater->update( std::make_pair(anUpdate, 1)); return *this; }
...
class StatStdDev : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_StdDev::update_type > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("StdDev"); return theType; }

    //Increment Counter
    StatStdDev & operator <<(stat_value_type::update_type anUpdate) { if (theUpdater) theUpdater->update(anUpdate); return *this; }
...
class StatLog2Histogram : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_Log2Histogram::update_type > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("Log2Histogram"); return theType; }
...
class StatWeightedLog2Histogram : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_WeightedLog2Histogram::update_type > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("WeightedLog2Histogram"); return theType; }
...
class StatStdDevLog2Histogram : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< aux_::StatValue_StdDevLog2Histogram::update_type > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("StdDevLog2Histogram"); return theType; }
...
class StatUniqueCounter : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< CountedValueType > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("UniqueCounter"); return theType; }

    //Count operator
    StatUniqueCounter & operator <<( typename stat_value_type::update_type anUpdate) { if (theUpdater) theUpdater->update(anUpdate); return *this; }
...
class StatInstanceCounter : public Stat, public aux_::StatUpdaterLink< aux_::StatUpdater< typename aux_::StatValue_InstanceCounter<CountedValueType>::update_type > > {
  ...
  public:
    ...
    std::string const & type() const { static std::string theType("InstanceCounter"); return theType; }
