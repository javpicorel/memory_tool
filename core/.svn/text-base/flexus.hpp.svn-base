...
class FlexusInterface {
   public:
    ...
    //The main cycle function
      ...
      virtual void advanceCycles(long long aCycleCount) = 0;
    ...
    //Simulator state inquiry
      ...
      virtual unsigned long long cycleCount() const = 0;
      virtual bool initialized() const = 0;

    //Watchdog Functions
      virtual void watchdogCheck() = 0;
      virtual void watchdogIncrement() = 0;
      virtual void watchdogReset(unsigned int anIndex) = 0;

    //Debugging support functions
      virtual int breakCPU() const = 0;
      virtual int breakInsn() const = 0;

      virtual void onTerminate( boost::function<void () > ) = 0;
      virtual void terminateSimulation() = 0;
      virtual void quiesce() = 0;
      virtual void quiesceAndSave(unsigned int aSaveNum) = 0;
