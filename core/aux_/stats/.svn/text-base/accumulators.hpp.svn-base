...
namespace aux_ {
  ...
  inline boost::intrusive_ptr<StatValueBase> StatValueBase::countAccumulator() { return new StatValue_CountAccumulator(); }
  ...
  inline boost::intrusive_ptr<StatValueBase> StatValue_Counter::avgAccumulator() { return new StatValue_AvgAccumulator(theValue); }
  inline boost::intrusive_ptr<StatValueBase> StatValue_Average::avgAccumulator() { return new StatValue_AvgAccumulator(theTotal); }
    ...
    public:
      ...
      long long asLongLong() const {
        if (k <= 1) {
          ...
          return static_cast<long long>( sqrt( SigmaSqSum/k ) / sqrt(k-1) );
        }
      }
      double asDouble() const {
        if (k <= 1) {
  ...
  inline boost::intrusive_ptr<StatValueBase> StatValue_Counter::stdevAccumulator() { StatValue_StdDevAccumulator * stdev = new StatValue_StdDevAccumulator(); stdev->update(theValue); return stdev; }
  inline boost::intrusive_ptr<StatValueBase> StatValue_Average::stdevAccumulator() { StatValue_StdDevAccumulator * stdev = new StatValue_StdDevAccumulator(); stdev->update(static_cast<double>(theTotal) / theCount); return stdev; }
