...
namespace aux_ {
  ...
  class StatValue_Counter : public StatValueBase {
    ...
    public:
      ...
      long long asLongLong() const { return theValue; };
  };
...
/*
  class StatValue_DoubleCounter : public StatValueBase {
    ...
    public:
      ...
      long long asLongLong() const { return static_cast<long long>( theValue ); };
  };
*/
  ...
  class StatValue_Annotation : public StatValueBase {
    ...
    public:
      ...
      long long asLongLong() const { return 0; };
  };
    ...
    public:
      ...
      long long asLongLong() const {
        if (k == 0) {
          ...
          return static_cast<long long>( sqrt(SigmaSqSum) / static_cast<double>(k) );
        }
      }
      double asDouble() const {
        if (k == 0) {
