...
namespace aux_ {
  ...
  class SimpleMeasurement : public Measurement {
    ...
    public:
      ...
      long long asLongLong( std::string const & aStat);
      double asDouble( std::string const & aStat);
      long long sumAsLongLong( std::string const & aStatFilter);
      long long minAsLongLong( std::string const & aStatFilter);
      long long maxAsLongLong( std::string const & aStatFilter);
  ...
  class PeriodicMeasurement : public Measurement {
    ...
    public:
      PeriodicMeasurement( std::string const & aName, std::string const & aStatExpression, long long aPeriod, accumulation_type anAccumulationType);
  ...
  class LoggedPeriodicMeasurement : public Measurement {
    ...
    public:
      LoggedPeriodicMeasurement( std::string const & aName, std::string const & aStatExpression, long long aPeriod, accumulation_type anAccumulationType, std::ostream & anOstream);
