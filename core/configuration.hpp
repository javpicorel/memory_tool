...
struct ConfigurationManager : private noncopyable {
  ...
  virtual void processCommandLineConfiguration(int anArgc, char ** anArgv) = 0;
...
namespace aux_ {
        ...
        struct FLEXUS_CONFIGURATION_WARNING {
           FLEXUS_CONFIGURATION_WARNING() {
              int WARNING__FLEXUS_PARAMETER_VALUE_IS_NOT_SPECIFIED_IN_WIRING;
           }
        };
        ...
        struct CompileValue {
          std::string theValue;
            ...
            : theValue(aValue)
           {
                    ...
                    FLEXUS_CONFIGURATION_ERROR<ParamStruct, Type, Member> error; (void)error;
        ...
        struct DynamicParameter : public ParameterBase {
                ...
                template < typename T > T &toString(T &v) { return v; }
                template < bool > const char *toString(bool &v) { return (v?"true":"false"); }
